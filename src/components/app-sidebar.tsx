...
type AppSidebarProps = Readonly<{ category: 'sorting' | 'searching'; algorithms: readonly AlgorithmSummary[]; selectedId: string; onSelect: (algorithmId: string) => void }>

export function AppSidebar({ category, algorithms, selectedId, onSelect }: AppSidebarProps) {
