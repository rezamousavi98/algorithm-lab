...
type WorkspaceErrorBoundaryProps = Readonly<{ children: ReactNode; category?: 'sorting' | 'searching' }>
...
> {
  ...
  render() {
    ...
    const category = this.props.category ?? 'sorting'
    if (error) {
      return (
        <section className="workspace-recovery" role="alert">
          ...
          <div className="recovery-actions">
            ...
            <a className="button" href={`#${category}-algorithms`}>Return to algorithms <ArrowRight size={14} /></a>
